...
import 'package:ui_animation/screens/animation/value_change_animated.dart';
        ...
        SliverAppBar(
          ...
          flexibleSpace: FlexibleSpaceBar(
            ...
            children: [
              ...
              Positioned(
                  left: 40,
                  top: MediaQuery.of(context).size.height * 0.3 - radiusAvatar,
                  child: CircleAvatar(
                    radius: radiusAvatar,
                    backgroundColor: Colors.white,
                    child: CircleAvatar(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              Strings.sizeLever,
                              style: GoogleFonts.montserrat(
                                  textStyle: TextStyleApp.styleActionIndicator),
                            )
                          ],
                        ),
                      ),
                          ...
                          child:ClipOval(
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                child:const SizedBox(width: 30, height: 30, child: Icon(Icons.facebook,color: Colors.white,)),
                              ),
                            ),
                          )
                      ),
                        ...
                        child:ClipOval(
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              child:const SizedBox(width: 30, height: 30, child: Icon(Icons.discord,color: Colors.white,)),
                            ),
                          ),
                        )
                      ),
